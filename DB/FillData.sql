...
INSERT dbo.Roles(Id, Name) VALUES (NEWID(), N'Originator')
INSERT dbo.Roles(Id, Name) VALUES (NEWID(), N'Traveler')
INSERT dbo.Roles(Id, Name) VALUES (NEWID(), N'First Authoriser')
INSERT dbo.Roles(Id, Name) VALUES (NEWID(), N'Second Authoriser')
INSERT dbo.Roles(Id, Name) VALUES (NEWID(), N'Manager')
select * from [dbo].[TravelRequest]



Select cast(Scheme as xml) from dbo.WorkflowScheme
...
Select * from dbo.EmployeeRole

INSERT dbo.EmployeeRole(EmployeeId, RoleId) VALUES ('0215EFD5-DA17-497A-8EF6-8A2E44F1AE20', '3F2E45D1-B3EA-49A5-B467-C2F1B3CF3544') -- divya
INSERT dbo.EmployeeRole(EmployeeId, RoleId) VALUES ('CD2AF95D-0598-4333-99D1-5332A3CC661C', '12D8F7AC-E1D0-4AF9-86D6-B2325017C1F0') -- Sandeep
INSERT dbo.EmployeeRole(EmployeeId, RoleId) VALUES ('B2F2B5B6-2C19-40A1-9723-C2E5C3BCB96E', 'FBE815E3-BF6E-40B6-A28A-96A2B98EFE8E') -- Suresh
INSERT dbo.EmployeeRole(EmployeeId, RoleId) VALUES ('FA7F7C7B-AA3B-4B38-9121-38721EFAAA11', 'B8FDEECB-7616-49E4-A4AD-C6CF346ED262') -- Sharron
INSERT dbo.EmployeeRole(EmployeeId, RoleId) VALUES ('61750B1D-2CFD-47F7-9CEF-A6DEE815DDEC', '4C00BEC9-B347-4E27-8504-C5B58240DCE2') -- Scott

CREATE TABLE dbo.TravelRequest
(
    Id UNIQUEIDENTIFIER PRIMARY KEY,
    Number INT IDENTITY,
    TravelRequestNumber NVARCHAR(256) NOT NULL,
...
INSERT dbo.Employee(Id, Name, StructDivisionId, IsHead) VALUES (NEWID(), N'Scott'		, 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 0)
INSERT dbo.Employee(Id, Name, StructDivisionId, IsHead) VALUES (NEWID(), N'Sharron'	, 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 0)
INSERT dbo.Employee(Id, Name, StructDivisionId, IsHead) VALUES (NEWID(), N'Suresh'	, 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 0)
INSERT dbo.Employee(Id, Name, StructDivisionId, IsHead) VALUES (NEWID(), N'Sandeep'	, 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 0)
INSERT dbo.Employee(Id, Name, StructDivisionId, IsHead) VALUES (NEWID(), N'Divya'		, 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 0)
INSERT dbo.Employee(Id, Name, StructDivisionId, IsHead) VALUES (NEWID(), N'Prudhvi'	, 'f6e34bdf-b769-42dd-a2be-fee67faf9045', 0)
