...
namespace WF.Sample.Business.Workflow
{
    public static class WorkflowInit
    {
            ...
            if (_runtime == null)
            {
                lock (_sync)
                {
                    if (_runtime == null)
                    {
                        ...
                        basicPlugin.UpdateDocumentStateAsync += UpdateTravelRequestStateAsync;
                        ...
                        externalParametersProvider.GetTravelRequest += GetTravelRequest;
                        ...
                        _runtime
                            ...
                            .WithDesignerAutocompleteProvider(new AutoCompleteProvider(DataServiceProvider.Get<ISettingsProvider>()))
        ...
        {
            var doc = GetTravelRequest(processInstance);
        ...
        public static async Task UpdateTravelRequestStateAsync(ProcessInstance processInstance, string stateName, string  localizedStateName)
        {
            var docRepository = DataServiceProvider.Get<ITravelRequestRepository>();
            docRepository.ChangeState(processInstance.ProcessId, stateName, localizedStateName);
        }

        public static TravelRequest GetTravelRequest(ProcessInstance processInstance)
        {
            var docRepository = DataServiceProvider.Get<ITravelRequestRepository>();
